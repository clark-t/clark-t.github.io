...
exports.uuidStore = exports.uaStore = exports.featureStore = undefined;
exports.getStore = getStore;

var _localforage = __webpack_require__(87);
...
var featureStore = exports.featureStore = getStore('feature');
 ...
 * @type {Object}
 */
var uaStore = exports.uaStore = getStore('ua');
 ...
 * @type {Object}
 */
var uuidStore = exports.uuidStore = getStore('uuid');
...
exports.uaParse = exports.one = exports.reload = exports.checkProperty = exports.checkProperties = exports.unregister = exports.register = exports.init = undefined;
...
var init = exports.init = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(scopes) {
        var sw, results;
...
var register = exports.register = function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(filePath, scope) {
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        return _context2.abrupt('return', navigator.serviceWorker.register(filePath, { scope: scope }));
...
var unregister = exports.unregister = function () {
    var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(scopes) {
        var _this = this;
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        arr = Array.isArray(scopes) ? scopes : [scopes];
                        _context4.next = 3;
                        return _promise2.default.all(arr.map(function () {
                            var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(scope) {
                                var reg;
                                return _regenerator2.default.wrap(function _callee3$(_context3) {
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            case 0:
                                                reg = void 0;
                                                _context3.t0 = typeof scope === 'undefined' ? 'undefined' : (0, _typeof3.default)(scope);
                                                _context3.next = _context3.t0 === 'string' ? 4 : _context3.t0 === 'undefined' ? 4 : _context3.t0 === 'object' ? 8 : 10;
                                                break;
    ...
    return function unregister(_x4) {
...
var uaParse = exports.uaParse = function () {
    var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11() {
        var parser, _parser$getResult, browser, os, device, ua, deviceTip;

        return _regenerator2.default.wrap(function _callee11$(_context11) {
            while (1) {
                switch (_context11.prev = _context11.next) {
                    case 0:
                        parser = new _uaParserJs2.default();
                        _parser$getResult = parser.getResult(), browser = _parser$getResult.browser, os = _parser$getResult.os, device = _parser$getResult.device, ua = _parser$getResult.ua;
                        deviceTip = (device.type || '---') + ' ' + (device.model || '---') + ' ' + (device.vendor || '---');
                        ...
                        _context11.next = 8;
                        return _promise2.default.all([_store.uaStore.setItem('browser', (0, _stringify2.default)(browser)), _store.uaStore.setItem('os', (0, _stringify2.default)(os)), _store.uaStore.setItem('device', (0, _stringify2.default)(device)), _store.uaStore.setItem('ua', (0, _stringify2.default)(ua))]);
...
exports.createStepTest = createStepTest;
exports.showCaseName = showCaseName;

var _utils = __webpack_require__(64);

var _store = __webpack_require__(39);

var _uaParserJs = __webpack_require__(109);
...
function createOnce(_ref11) {
    var _this3 = this;

    var name = _ref11.name,
        _ref11$prefix = _ref11.prefix,
        prefix = _ref11$prefix === undefined ? 'pwa-test-once-' : _ref11$prefix;
...
function createStepTest(totalStep, onSuccess, onFail) {
    var currentStepNo = 0;
    var isFinished = false;

    var tester = function tester(expectStepNo) {
        if (isFinished) {
            return;
        }
    ...
    tester.currentStep = function () {
        return currentStepNo;
    };
    tester.isFinished = function () {
        return isFinished;
    };
    ...
    */
    ...
    if (typeof(exports) !== UNDEF_TYPE) {
        ...
        */
        ...
        if ("function" === FUNC_TYPE && __webpack_require__(110)) {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.next = 2;
                        return logStore.getItem(scope + 'lock');
                    ...
                    case 4:
                        _context2.next = 6;
                        return logStore.setItem(scope + 'lock', name);
                    ...
                    case 8:
                        lock = _context2.sent;
                        return _context2.abrupt('return', lock === name);
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        _context3.next = 2;
                        return logStore.setItem(scope + 'lock', '');
...
var swLog = exports.swLog = function () {
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        _context4.next = 2;
                        return (0, _helper.until)(lock.bind(null, 'sw' + Math.floor(Math.random() * Date.now())));

                    case 2:
                        _context4.next = 4;
                        return logStore.getItem(scope + 'stack');
                    ...
                    case 4:
                        ...
                        stack = (0, _stringify2.default)(stack);
                        _context4.next = 9;
                        return logStore.setItem(scope + 'stack', stack);
...
var _helper = __webpack_require__(45);
...
var logStore = (0, _store.getStore)('log');
...
function log() {
    ...
    if (typeof document === 'undefined') {
        swLog.apply(undefined, (0, _toConsumableArray3.default)(args));
    } else {
        mainLog.apply(undefined, (0, _toConsumableArray3.default)(args));
    }
}
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 8:
                                stack = _context.sent;
                                _context.next = 11;
                                return logStore.setItem(scope + 'stack', '');
                            ...
                            case 13:
                                ...
                                try {
                                    ...
                                    stack.forEach(function (msg) {
                                        mainLog.apply(undefined, (0, _toConsumableArray3.default)(msg));
                                    });
                                } catch (e) {
                            ...
                            case 14:
                                return _context.abrupt('return', tictok());
...
function mainLog() {
    ...
    var html = logStack.sort(function (a, b) {
        return a[0] - b[0];
    }).map(function (msg) {
        var str = msg.slice(1).join(' - ');
    ...
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(_ref2) {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        (0, _helper.showCaseName)(name);
                        _context.next = 3;
                        return (0, _helper.init)(scope);

                    case 3:
                        _context.next = 5;
                        return (0, _helper.zero)(features);
...
var SRC = __webpack_require__(154)('src');
...
if (__webpack_require__(120)) {
  ...
  var createArrayIncludes = __webpack_require__(184);
  var speciesConstructor = __webpack_require__(191);
  var ArrayIterators = __webpack_require__(229);
  var Iterators = __webpack_require__(168);
  var $iterDetect = __webpack_require__(188);
...
var $export = __webpack_require__(16);
var shared = __webpack_require__(183)('metadata');
var store = shared.store || (shared.store = new (__webpack_require__(279))());
...
var defined = __webpack_require__(143);
var fails = __webpack_require__(116);
var spaces = __webpack_require__(214);
var space = '[' + spaces + ']';
var non = '\u200b\u0085';
...
var inheritIfRequired = __webpack_require__(215);
...
module.exports = __webpack_require__(155) || !__webpack_require__(116)(function () {
  var K = Math.random();
...
exports.default = function (scope) {
            return {
                        name: 'fetch',
                        scope: scope,
                        features: ['Promise', 'fetch', 'Request', 'Response', 'Headers', 'fetchEvent', 'fetchEvent.request', 'fetchEvent.respondWith'],
                        main: function main() {
                                    var _this = this;

                                    return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                                                var value, reg, response, data;
                                                return _regenerator2.default.wrap(function _callee$(_context) {
                                                            while (1) {
                                                                        switch (_context.prev = _context.next) {
                                                                                    case 0:
                                                                                                (0, _log.log)('fetch: start');

                                                                                                value = Number(!!window.Promise);
                                                                                                _context.next = 4;
                                                                                                return (0, _helper.grade)('Promise', value);

                                                                                    case 4:
                                                                                                // .then(() => {
                                                                                                //     fetch('/asdfasdfasdf/grade finish');
                                                                                                // });
                                                                                                (0, _log.log)('- Promise done -', value);

                                                                                                /* eslint-disable fecs-camelcase */
                                                                                                _context.next = 7;
                                                                                                return (0, _helper.checkProperties)(window, {
                                                                                                            fetch: 0.5,
                                                                                                            Request: 1,
                                                                                                            Response: 0.5,
                                                                                                            Headers: 1
                                                                                    ...
                                                                                    case 7:
                                                                                                ...
                                                                                                (0, _log.log)('fetch: register sw.js');
                                                                                    ...
                                                                                    case 19:
                                                                                                ...
                                                                                                (0, _log.log)('fetch: registered');

                                                                                                (0, _log.log)('fetch: sleep 3s');
                                                                                    ...
                                                                                    case 23:
                                                                                                ...
                                                                                                (0, _log.log)('fetch: start to fetch');
                                                                                    ...
                                                                                    case 30:
                                                                                                ...
                                                                                                (0, _log.log)('fetch: get response', data);
                                                                                                ...
                                                                                                _context.t1 = _promise2.default;
                                                                                                _context.next = 36;
                                                                                                return (0, _helper.grade)('fetch', 1);

                                                                                    case 36:
                                                                                                _context.t2 = _context.sent;
                                                                                                _context.next = 39;
                                                                                                return (0, _helper.grade)('Response', 1);

                                                                                    case 39:
                                                                                                _context.t3 = _context.sent;
                                                                                                _context.t4 = [_context.t2, _context.t3];
                                                                                                _context.next = 43;
                                                                                                return _context.t1.all.call(_context.t1, _context.t4);

                                                                                    case 43:
                                                                                                (0, _log.log)('fetch: full score');
                                                                                    ...
                                                                                    case 47:
                                                                                                _context.next = 49;
                                                                                                return (0, _helper.unregister)(reg);

                                                                                    case 49:

                                                                                                (0, _log.log)('fetch: test finish');
                        ...
                        error: function error(e) {
                                    (0, _log.log)('error in fetch');
                                    (0, _log.log)((0, _stringify2.default)(e));
                                    // fetch('error in fetch')
                                    // fetch('/daf/' + JSON.stringify(e))
                        }
            };
};
                        ...
                        switch (_context.prev = _context.next) {
                            ...
                            case 23:
                                ...
                                if (tags.includes('syncEventTest')) {
                                    (0, _log.log)('exist syncEventTest background');
                                } else {
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(138)(Function.call, __webpack_require__(135).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(130)(IteratorPrototype, __webpack_require__(119)('iterator'), function () { return this; });
...
var cel = __webpack_require__(208);
var global = __webpack_require__(115);
var process = global.process;
var setTask = global.setImmediate;
var clearTask = global.clearImmediate;
...
var process = global.process;
var Promise = global.Promise;
var isNode = __webpack_require__(139)(process) == 'process';
...
var toIndex = __webpack_require__(281);
var gOPN = __webpack_require__(159).f;
var dP = __webpack_require__(121).f;
var arrayFill = __webpack_require__(228);
var setToStringTag = __webpack_require__(166);
var ARRAY_BUFFER = 'ArrayBuffer';
...
module.exports = !__webpack_require__(120) && !__webpack_require__(116)(function () {
...
var ws = __webpack_require__(214);
var hex = /^[-+]?0[xX]/;
...
module.exports = 1 / $parseFloat(__webpack_require__(214) + '-0') !== -Infinity ? function parseFloat(str) {
  var string = $trim(String(str), 3);
...
// 21.2.5.3 get RegExp.prototype.flags()
if (__webpack_require__(120) && /./g.flags != 'g') __webpack_require__(121).f(RegExp.prototype, 'flags', {
  configurable: true,
...
var anInstance = __webpack_require__(161);
var forOf = __webpack_require__(162);
var $iterDefine = __webpack_require__(220);
var step = __webpack_require__(272);
var setSpecies = __webpack_require__(160);
var DESCRIPTORS = __webpack_require__(120);
...
var $WeakMap = module.exports = __webpack_require__(192)(WEAK_MAP, wrapper, methods, weak, true, true);
...
var redefineAll = __webpack_require__(163);
var getWeak = __webpack_require__(150).getWeak;
var anObject = __webpack_require__(114);
var isObject = __webpack_require__(117);
var anInstance = __webpack_require__(161);
var forOf = __webpack_require__(162);
...
var gOPS = __webpack_require__(185);
var anObject = __webpack_require__(114);
var Reflect = __webpack_require__(115).Reflect;
...
var getKeys = __webpack_require__(156);
var toIObject = __webpack_require__(134);
var isEnum = __webpack_require__(173).f;
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        test('in main');
                        features = _demos2.default.reduce(function (arr, demo) {
                            if (demo.features) {
                    ...
                    case 5:
                        if (!(i < _demos2.default.length)) {
                            _context.next = 12;
                            break;
                        }

                        _context.next = 8;
                        return run(_demos2.default[i]);

                    case 8:
                        console.log(_demos2.default[i].name + ' finish');
...
var _demos = __webpack_require__(353);
...
try {
    ...
    var err = (0, _stringify2.default)(e);
    test('in error');
    test(e);
}
...
var _sequence = __webpack_require__(354);

var _sequence2 = _interopRequireDefault(_sequence);

var _sequence3 = __webpack_require__(355);

var _sequence4 = _interopRequireDefault(_sequence3);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = [_sequence2.default, _sequence4.default];
...
var _demo = __webpack_require__(207);
...
$export($export.S + $export.F * !__webpack_require__(120), 'Object', { defineProperty: __webpack_require__(121).f });
...
$export($export.S + $export.F * !__webpack_require__(120), 'Object', { defineProperties: __webpack_require__(258) });
...
var isObject = __webpack_require__(117);
var meta = __webpack_require__(150).onFreeze;
...
$export($export.P, 'Function', { bind: __webpack_require__(261) });
...
if (!(HAS_INSTANCE in FunctionProto)) __webpack_require__(121).f(FunctionProto, HAS_INSTANCE, { value: function (O) {
...
var $export = __webpack_require__(16);
var $parseFloat = __webpack_require__(264);
...
var BROKEN_COF = cof(__webpack_require__(158)(proto)) == NUMBER;
...
var $export = __webpack_require__(16);
var _isFinite = __webpack_require__(115).isFinite;
...
var $export = __webpack_require__(16);
var isInteger = __webpack_require__(266);
var abs = Math.abs;
...
var $export = __webpack_require__(16);
var log1p = __webpack_require__(267);
var sqrt = Math.sqrt;
...
var $export = __webpack_require__(16);
var $at = __webpack_require__(219)(false);
...
var $export = __webpack_require__(16);
var toLength = __webpack_require__(122);
var context = __webpack_require__(222);
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(130)(proto, TO_PRIMITIVE, __webpack_require__(440));
...
$export($export.P + $export.F * (__webpack_require__(172) != Object || !__webpack_require__(140)(arrayJoin)), 'Array', {
...
$export($export.P + $export.F * (fails(function () {
  ...
  test.sort(null);
  // Old WebKit
}) || !__webpack_require__(140)($sort)), 'Array', {
...
var $export = __webpack_require__(16);
var $forEach = __webpack_require__(146)(0);
var STRICT = __webpack_require__(140)([].forEach, true);
...
var $export = __webpack_require__(16);
var $map = __webpack_require__(146)(1);

$export($export.P + $export.F * !__webpack_require__(140)([].map, true), 'Array', {
...
var $export = __webpack_require__(16);
var $filter = __webpack_require__(146)(2);

$export($export.P + $export.F * !__webpack_require__(140)([].filter, true), 'Array', {
...
var $export = __webpack_require__(16);
var $some = __webpack_require__(146)(3);

$export($export.P + $export.F * !__webpack_require__(140)([].some, true), 'Array', {
...
var $export = __webpack_require__(16);
var $every = __webpack_require__(146)(4);

$export($export.P + $export.F * !__webpack_require__(140)([].every, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(140)([].reduce, true), 'Array', {
...
$export($export.P + $export.F * !__webpack_require__(140)([].reduceRight, true), 'Array', {
...
var $export = __webpack_require__(16);
var $indexOf = __webpack_require__(184)(false);
var $native = [].indexOf;
var NEGATIVE_ZERO = !!$native && 1 / [1].indexOf(1, -0) < 0;

$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(140)($native)), 'Array', {
...
var $export = __webpack_require__(16);
var $find = __webpack_require__(146)(5);
var KEY = 'find';
var forced = true;
...
var $export = __webpack_require__(16);
var $find = __webpack_require__(146)(6);
var KEY = 'findIndex';
var forced = true;
// Shouldn't skip holes
if (KEY in []) Array(1)[KEY](function () { forced = false; });
...
var gOPN = __webpack_require__(159).f;
var isRegExp = __webpack_require__(187);
var $flags = __webpack_require__(189);
...
if (__webpack_require__(120) && (!CORRECT_NEW || __webpack_require__(116)(function () {
...
__webpack_require__(192)(WEAK_SET, function (get) {
...
var toLength = __webpack_require__(122);
var isObject = __webpack_require__(117);
var ArrayBuffer = __webpack_require__(115).ArrayBuffer;
var speciesConstructor = __webpack_require__(191);
var $ArrayBuffer = buffer.ArrayBuffer;
var $DataView = buffer.DataView;
...
__webpack_require__(160)(ARRAY_BUFFER);
...
__webpack_require__(148)('Int8', 1, function (init) {
...
__webpack_require__(148)('Uint8', 1, function (init) {
...
__webpack_require__(148)('Int16', 2, function (init) {
...
__webpack_require__(148)('Uint16', 2, function (init) {
...
__webpack_require__(148)('Int32', 4, function (init) {
...
__webpack_require__(148)('Uint32', 4, function (init) {
...
__webpack_require__(148)('Float32', 4, function (init) {
...
__webpack_require__(148)('Float64', 8, function (init) {
...
var aFunction = __webpack_require__(126);
var anObject = __webpack_require__(114);
var rApply = (__webpack_require__(115).Reflect || {}).apply;
...
var rConstruct = (__webpack_require__(115).Reflect || {}).construct;
...
var $export = __webpack_require__(16);
var getProto = __webpack_require__(136);
var anObject = __webpack_require__(114);
...
var $export = __webpack_require__(16);
var $includes = __webpack_require__(184)(true);
...
__webpack_require__(151)('flatMap');
...
__webpack_require__(151)('flatten');
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = __webpack_require__(16);
var $pad = __webpack_require__(284);
...
var toLength = __webpack_require__(122);
var isRegExp = __webpack_require__(187);
var getFlags = __webpack_require__(189);
...
__webpack_require__(221)($RegExpStringIterator, 'RegExp String', function next() {
...
var $export = __webpack_require__(16);
var $values = __webpack_require__(285)(false);
...
// https://github.com/tc39/proposal-object-values-entries
var $export = __webpack_require__(16);
var $entries = __webpack_require__(285)(true);
...
__webpack_require__(120) && $export($export.P + __webpack_require__(194), 'Object', {
...
__webpack_require__(196)('WeakSet');
...
$export($export.G, { global: __webpack_require__(115) });
...
$export($export.S, 'Math', { scale: __webpack_require__(288) });
...
var metadata = __webpack_require__(149);
var anObject = __webpack_require__(114);
...
var $export = __webpack_require__(16);
var microtask = __webpack_require__(231)();
var process = __webpack_require__(115).process;
var isNode = __webpack_require__(139)(process) == 'process';
...
var $export = __webpack_require__(16);
var $task = __webpack_require__(230);
...
module.exports = __webpack_require__(141).RegExp.escape;
