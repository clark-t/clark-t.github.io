    ...
    if (event.waitUntil) {
        event.waitUntil(
            ...
            .then(function (store) {
                ...
                .then(function (data) {
                    ...
                    data.log += '|' + Date.now() + ': sw 2 on install';

                    return store.put(data);
                })
                .then(function (data) {
                    console.log('on install sw 2 before wait');
                    console.log(data);
                });
            })
            ...
            .then(function (store) {
                ...
                .then(function (data) {
                    ...
                    data.log += '|' + Date.now() + ': sw 2 on install after 3s';

                    return store.put(data);
                })
                .then(function (data) {
                    console.log('on install sw 2 after wait');
                    console.log(data);
                });
            })
        );
        ...
        .then(function (store) {
            ...
            .then(function (data) {
                ...
                data.log += '|' + Date.now() + ': sw 2 install does not have wait until';
                return store.put(data);
            });
        });
    }
    ...
    event.waitUntil(
        ...
        .then(function (store) {
            ...
            .then(function (data) {
                ...
                data.log += '|' + Date.now() + ': sw 2 on activate';

                return store.put(data);
            })
            .then(function (data) {
                console.log('on activate sw 2 before wait');
                console.log(data);
            });
        })
        .then(function () {
        ...
        .then(function (store) {
            ...
            .then(function (data) {
                ...
                data.log += '|' + Date.now() + ': sw-2 activate';

                return store.put(data);
            })
            .then(function (data) {
                console.log('on activate sw 2 after wait');
                console.log(data);
            });
        })
    );
